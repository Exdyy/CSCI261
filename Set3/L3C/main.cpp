...
int main()
{
    ...
    cout << "Step 7 - iNum value: " << *pINum1 << " (Printed using dereference pointer, *pINum1)" << endl;          //Step 7
    //pINum2 = &dNum;                                                                                               //Step 8
    //Error:
    ...
    cout << "Step 10 - dNum value: " << *pDNum << " (Printed using dereferenced pointer, *pDNum)" << endl;          //Step 10.2

    iNum = 7;                                                                                                       //Step 11
    cout << "Step 12 - iNum value: " << *pINum1 << " (Printed using dereference pointer, *pINum1)" << endl;         //Step 12
    
    pINum2 = pINum1;                                                                                                //Step 13
    cout << "Step 14 - pINum2 address: " << pINum2 << " (Printed using direct call to variable, pINum2)" << endl;   //Step 14
    cout << "Step 15 - pINum2 points to: " << *pINum2 << " (Printed using dereferenced pointer, *pINum2)" << endl;  //Step 15
